import { Users, PlusCircle, FileText, Settings, LogOut, LayoutDashboard, Activity, TrendingUp, CalendarDays } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Agendamentos", url: "/dashboard/appointments", icon: CalendarDays },
